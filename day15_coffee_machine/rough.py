...
def ingredient_check(order):
    ...
    if water_qty<100 or coffee_qty<18 or milk_qty<100:
        print("sorry need refill. Exiting")
        return False
    else:
        if order=='e':
            water_qty -= 50
...
while not_need_maintenance:
    ...
    print(f"not need maint flag: {not_need_maintenance}")
